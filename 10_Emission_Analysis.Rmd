...
GE_combined      <- read.csv("data/GE_combined.csv")          
yield_data       <- read.csv("data/yield_data.csv")
weights_unique   <- read.csv("data/weights_unique.csv")
...
```{r}
# # 0) Yield papers (unique B.Codes that have yield linked)
...
#     by = "B.Code"
#   ) %>%
#   count(P.Product, name = "Papers_with_practice_≥2_classified_and_yield")

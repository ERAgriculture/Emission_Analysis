...
merged_metadata <- readRDS("~/ERL/Emission_Analysis/data/merged_metadata_harmonized.rds")

ingredients <- readRDS("~/ERL/Emission_Analysis/data/ingredients_harmonized.rds")

...
```{r}
Gross_energy <- read.csv("~/ERL/Emission_Analysis/data/Gross_energy.csv")
...
total_amounts <- read.csv("~/ERL/Emission_Analysis/data/total_amounts.csv")
feed_intake_ingredients <- read.csv("~/ERL/Emission_Analysis/data/feed_intake_ingredients_harmonized.csv")
feed_intake_diet <- read.csv("~/ERL/Emission_Analysis/data/feed_intake_diet_harmonized.csv")
...
```{r}
write.csv(GE_combined, "~/ERL/Emission_Analysis/data/GE_Combined.csv")
write.csv(yield_data, "~/ERL/Emission_Analysis/data/yield_data.csv")

...
Ing_classif_long <- Ing_classif %>%
  ...
  select(B.Code, D.Item, DC.Variable, DC.Value)

nutr_ing <- build_nutr_table(Ing_classif_long, type_lookup, backfill_by_item = TRUE)
...
write.csv(classif_diet, "~/Emission_Analysis/data/classif_diet.csv")
write.csv(unmatched_diet, "~/Emission_Analysis/data/unmatched_diet.csv")

---
title: "9_Emission_Identidy_Practices"
...
classif_ing_simple <- read.csv("~/ERL/Emission_Analysis/data/classif_ing_simple.csv")
merged_metadata <- readRDS("~/ERL/Emission_Analysis/data/merged_metadata_nutrition_inference.rds")
GE_combined<-read.csv("~/ERL/Emission_Analysis/data/GE_combined.csv")

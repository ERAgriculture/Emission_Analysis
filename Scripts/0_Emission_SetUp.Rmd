...
diet_cols   <- c("B.Code","A.Level.Name","D.Item",
                 ...
                 "D.Unit.Animals","DC.Is.Dry","D.Ad.lib","D.Item.Group","D.Item.AOM","AOM.Scientific.Name")
...
data_cols <- c("B.Code","A.Level.Name","Out.Code.Joined",
               ...
               "Out.WG.Start","Out.WG.Unit","P.Product","is_entire_diet","is_group","T.Animals","T.Name","Country")
...
saveRDS(merged_metadata, "C:/Users/mlolita/OneDrive - CGIAR/Alliance - ClimateActionNetZero - 1_Projects/G227-A1712_SAAF/2_Technical & Data/Lolita Emissions Paper/Emission_Analysis/data/merged_metadata.rds")   # single file

...
write.csv(ingredients, "~/Emission_Analysis/data/ingredients_harmonized_subset.csv")

saveRDS(merged_metadata, "~/Emission_Analysis/data/merged_metadata_harmonized_subset.rds")
